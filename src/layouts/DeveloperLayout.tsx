...
import { Home, UserCheck, Users, LayoutDashboard } from 'lucide-react'
import { Navbar } from '@/components/shared/Navbar'
import { Sidebar, MobileSidebar } from '@/components/shared/Sidebar'
import { Sheet, SheetContent } from '@/components/ui/sheet'

const navItems = [
  { label: 'Dashboard', href: '/developer', icon: Home },
  { label: 'Access Requests', href: '/developer/access-requests', icon: UserCheck },
  { label: 'User Management', href: '/developer/user-management', icon: Users },
  { label: 'Overview', href: '/developer/overview', icon: LayoutDashboard },
]
